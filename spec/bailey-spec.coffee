describe "Bailey.js grammar", ->
  grammar = null

  beforeEach ->
    waitsForPromise ->
      atom.packages.activatePackage("language-bailey")

    runs ->
      grammar = atom.syntax.grammarForScopeName("source.bs")

  it "parses the grammar", ->
    expect(grammar).toBeTruthy()
    expect(grammar.scopeName).toBe "source.bs"
